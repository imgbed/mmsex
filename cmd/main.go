...
import (
	...
	"github.com/gohouse/golib/tgbot/api/apiv2"
	"github.com/gohouse/golib/tgbot/api/apiv3"
	"github.com/gohouse/golib/tgbot/api/bak"
	"github.com/gohouse/golib/tgbot/cors"
)
...
func main() {
	...
	bot.Listen("djt", apiv3.NewPCS(bot.Store))
